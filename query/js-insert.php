...
<script type="text/javascript" src="<?php echo $head_url;?>/assets/js/format_amount.js"></script>
...
<script>					
    $(function() {
        ...
        $("#comp_name").autocomplete({
            source: "<?php echo $head_url;?>/include/company_search.php",
            minLength: 1,
        });		
    ...
    $("#city_id").focusout(function() {
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo $head_url;?>/insert/bankers_mapping.php",
