                ...
                <div class="span9">
                    ...
                    <fieldset>
                        ...
                        <form method="post" action="index.php" name="searchfrm" autocomplete="off" onsubmit="return filter_validation()">
                            ...
                            <a href="https://astechnos.com/crmsml/report/download-query.php?page=1&fetchdata=<?php echo base64_encode($downloadreportqry);?>" target="_blank"><input class="cursor" type="button" value="Download"></a>
                        </form>
                    </fieldset>
