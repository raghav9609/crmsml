                ...
                <div class="span9">
                    ...
                    <fieldset>
                        ...
                        <form method="post" action="index.php" name="searchfrm" autocomplete="off" onsubmit="return filter_validation()">
                            ...
                            <a href="https://astechnos.com/crmsml/report/download-query.php?fetchdata=<?php echo base64_encode($downloadreportqry);?>"><input class="cursor" type="button" value="Download"></a>
                        </form>
                    </fieldset>
