...
require_once(dirname(__FILE__) . '/../include/display-name-functions.php');
    ...
    ================================================== -->
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <fieldset>
                        ...
                        <form method="post" action="customer.php" name="searchfrm" autocomplete="off" onsubmit="return filter_validation()">
            ...
            <script type="text/javascript" src="/crmsml/assets/js/common-function-call.js"></script>
    </body>
