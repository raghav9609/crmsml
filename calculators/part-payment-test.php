...
<body>
    <div style="margin-left: 25px; margin-top: 25px;"><a href="/sugar/calculators/rate_comparison.php"><input type="button" class="buttonsub" value="Go To - Rate Comparison Calculator"></a> <a href="/sugar/calculators/index.php"><input type="button" class="buttonsub" value="Go To - Simple Calculator"></a> </div>
