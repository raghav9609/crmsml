        ...
        <form action="" class="form-step col-12" autocomplete="off" id="form_step1">
                        ...
                        <div class="row div-width">
                            ...
                            <div class="form-group col-xl-2 col-lg-4 col-md-6">
                                ...
                                <input type="text" id="name" name="name" value="<?php echo ($get_bank_name['value']) ;?>" placeholder="Enter Bank Name" class="form-control alphaonly valid" maxlength="20" required="">
