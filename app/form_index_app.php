        ...
        <form action="" class="form-step col-12" autocomplete="off" id="form_step1">
                        ...
                        <div class="row div-width">
                            ...
                            <div class="form-group col-xl-2 col-lg-4 col-md-6">
                                ...
                                <input type="text" id="bank_name" name="bank_name" value="<?php echo ($get_bank_name) ;?>" placeholder="Enter Bank Name" class="form-control alphaonly" maxlength="20" required>
                            ...
                            <div class="form-group col-xl-2 col-lg-4 col-md-6">
                                ...
                                <div class="form-group col-xl-2 col-lg-4 col-md-6">
                                    <input type="text" class="text form-control" name="dob" id="dob" maxlength="10" value="<?php echo $disburse_date != '0000-00-00'?$disburse_date:'';?>" placeholder="yyyy-mm-dd" />
