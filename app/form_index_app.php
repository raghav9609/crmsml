        ...
        <form action="update_app.php" class="form-step col-12" autocomplete="off" id="form_step1">
            ...
            <div class="row div-width">
                ...
                <div class="form-group col-xl-2 col-lg-4 col-md-6">
                    ...
                    <input type="text" id="bank_name" name="bank_name" value="<?php echo ($get_bank_name['value']) ;?>" placeholder="Enter Bank Name" class="form-control alphaonly valid" maxlength="20" <?php echo ($get_bank_name['value'] != '') ? 'readonly' : ''; ?>  required disbaled>
