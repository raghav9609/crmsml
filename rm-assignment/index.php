...
if($_REQUEST['user_id'] > 0){
    $filter_data['user_id'] = $_REQUEST['user_id']; 
}
$data_to_display = $db_handle->runQuery($leadAssignmentClassexport->searchRM($filter_data));
?>
<!DOCTYPE html>
<html>
<head>
...
if (isset($_REQUEST["update"])) {
    ...
    <script>
       ...
       window.location.href = "<?php echo $head_url; ?>/rm-assignment/";  
    </script>
<?php } ?>