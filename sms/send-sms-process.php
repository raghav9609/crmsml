...
echo $url= 'https://bulkpush.mytoday.com/BulkSms/SingleMsgApi?feedid=385302&username=9920706289&password=SML2021@123&senderid=SML&To=91'.$subject.'&Text='.$description;
echo $response = curl_get_helper($url);
