...
$final_template = str_replace(array("{customer_name}","{agent_name}","{agent_number}","{loan_amount}","{application_id}","{bank_name}"),array(ucfirst($getQueryData[0]['customer_name']),ucfirst($getQueryData[0]['user_name']),'+91-'.$getQueryData[0]['agent_no'],$getQueryData[0]['loan_amount'],$query_id),$getEmailData[0]['description'],"bank");
