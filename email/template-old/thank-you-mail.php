	...
	'.$h_ins.'
		<tr style="background: #f7f7f7">
			<td style="text-align: left;padding: 0px 5%;font-size: 15px">
				...
				<p style="font-size: 14px">Thanks for choosing MyLoanCare.in for <b>Rs. '.number_format($loan_amt).'</b> '.$loan_type_name.' enquiry. A dedicated loan officer will call and assist you throughout the loan process.<br><br>Our services are FREE for our customers. Please feel free to write or call your loan officer for any assistance that you may require.
				</p>
